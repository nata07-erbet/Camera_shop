...
function RewiewList({ rewiews, rewiewCount }: RewiewListProps) {
  return (
    <ul className="review-block__list" data-testid="rewiew">
      {rewiews
        .sort(compare)
        .reverse()
        .slice(0, rewiewCount)
          ...
          <li className="review-card" key={rewiew.id}>
            ...
            <ul className="review-card__list">
              <li className="item-list">
                ...
                <p className="item-list__text">{rewiew.advantage}</p>
              </li>
              <li className="item-list">
                <span className="item-list__title">Недостатки:</span>
                <p className="item-list__text">{rewiew.disadvantage}</p>
              </li>
              <li className="item-list">
                <span className="item-list__title">Комментарий:</span>
                <p className="item-list__text">{rewiew.review}</p>
              </li>
            </ul>
          </li>
        ))}
